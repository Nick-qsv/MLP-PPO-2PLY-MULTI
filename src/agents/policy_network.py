...
class BackgammonPolicyNetwork(nn.Module):
    ...
    Architecture:
        ...
        - Hidden Layer:
            ...
            and ReLU activation.
        - Output Layer:
            Outputs a single logit and a state value estimate per board state.
    ...
    Attributes:
        ...
        action_head (nn.Linear): The fully connected layer mapping hidden representations to a single logit.
